 ...
 * 2019-05-31T17:03:55.263+07:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "file:src/main/resources/ipservice.wsdl.xml",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/main/resources/ipservice.wsdl.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:src/main/resources/ipservice.wsdl.xml");
        }
        WSDL_LOCATION = url;
    }
